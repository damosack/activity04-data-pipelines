...
**Response**: When message = TRUE, the message which R produces after
running code is shown in the knitted document. When message = FALSE,
only the code is included.
...
**Response**: Like the previous code chunk, the message option controls
whether the message that r offers after running the chunk is included in
the knitted markdown document or not. Included when message = TRUE, and
excluded when message = FALSE.
...
**Response**: To determine which major has the lowest unemployment rate
you would need the variables ‘major’ and ‘unemployment\_rate’. In Excel
I would sort the data by unemployment\_rate in ascending order, then
reference the major in the first row.
...
unemployment rate, tied for first with Military Technologies, Botany,
...
```
    ...
    ##     rank major_code major          major_category  total sample_size   men women
    ##    <dbl>      <dbl> <chr>          <chr>           <dbl>       <dbl> <dbl> <dbl>
    ##  1     3       2415 Metallurgical… Engineering       856           3   725   131
    ##  2     8       5001 Astronomy And… Physical Scien…  1792          10   832   960
    ##  3    11       2407 Computer Engi… Engineering     41542         399 33258  8284
    ##  4    15       2409 Engineering M… Engineering      4321          30  3526   795
    ##  5    19       2403 Architectural… Engineering      2825          26  1835   990
    ##  6    23       2502 Electrical En… Engineering     11565          97  8181  3384
    ##  7    31       2410 Environmental… Engineering      4047          26  2662  1385
    ##  8    39       2503 Industrial Pr… Engineering      4631          73  3477  1154
    ##  9    40       5102 Nuclear, Indu… Physical Scien…  2116          31   528  1588
    ## 10    42       3700 Mathematics    Computers & Ma… 72397         541 39956 32441
    ## # … with 14 more rows, and 13 more variables: sharewomen <dbl>, employed <dbl>,
